      ...
      <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        <div class="flex items-center space-x-2">
          <div class="w-8 h-8 bg-amber-500 rounded-lg flex items-center justify-center">
            <span class="text-slate-900 font-bold text-xl">围</span>
          </div>
          <h1 class="text-2xl font-bold text-white">围城</h1>
        </div>
        <button class="bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-lg transition-colors flex items-center space-x-2">
    ...
    <main class="container mx-auto px-4 py-12">
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="space-y-8">
          <div>
            <h2 class="text-5xl font-bold text-white mb-4">
              开始你的
              <span class="text-amber-400">围城</span>
              之旅
            </h2>
          ...
          <div class="grid grid-cols-3 gap-4">
            <div class="bg-slate-800/50 backdrop-blur rounded-lg p-4 text-center">
              <div class="text-2xl font-bold text-amber-400">1,234</div>
            ...
            <div class="bg-slate-800/50 backdrop-blur rounded-lg p-4 text-center">
              <div class="text-2xl font-bold text-blue-400">98.5%</div>
        ...
        <div class="space-y-6">
          ...
          <!-- AI vs Human -->
          <div class="bg-slate-800/50 backdrop-blur rounded-xl p-6 border border-slate-700 hover:border-amber-500 transition-all cursor-pointer group">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-4">
                ...
                <div>
                  <h4 class="text-lg font-semibold text-white group-hover:text-amber-400 transition-colors">人机对战</h4>
                  <p class="text-slate-400 text-sm">与AI对手切磋技艺</p>
                </div>
              </div>
              <svg class="w-5 h-5 text-slate-400 group-hover:text-amber-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Local Multiplayer -->
          <div class="bg-slate-800/50 backdrop-blur rounded-xl p-6 border border-slate-700 hover:border-green-500 transition-all cursor-pointer group">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-4">
                ...
                <div>
                  <h4 class="text-lg font-semibold text-white group-hover:text-green-400 transition-colors">本地对战</h4>
          ...
          <!-- Online Matchmaking -->
          <div class="bg-slate-800/50 backdrop-blur rounded-xl p-6 border border-slate-700 hover:border-blue-500 transition-all cursor-pointer group">
            <div class="flex items-center justify-between">
              <div class="flex items-center space-x-4">
                ...
                <div>
                  <h4 class="text-lg font-semibold text-white group-hover:text-blue-400 transition-colors">在线匹配</h4>
          ...
          <!-- Quick Play Button -->
          <button class="w-full bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white font-semibold py-4 rounded-xl transition-all transform hover:scale-105 shadow-lg">
            快速开始游戏
          </button>
        </div>
      </div>
